export default function Home() {
  const product = {
    ...
    priceRON: 349,
    image: "/images/i1756310110030_8045_0_8.jpg",
  ...
  return (
    <div style={{ maxWidth: 1120, margin: "0 auto", padding: "24px 16px" }}>
      ...
      <div style={{ borderRadius: 24, overflow: "hidden", boxShadow: "0 12px 30px #0001", marginTop: 16 }}>
        <img src={product.image} alt="SoleTheory" style={{ width: "100%", height: "auto", display: "block" }} />
      </div>

      <div style={{ marginTop: 24, border: "1px solid #eee", borderRadius: 20, overflow: "hidden", background: "#fff" }}>
        ...
        <div style={{ padding: 12 }}>
          ...
          <a
            href={waLink(product.name, product.priceRON)}
            style={{
